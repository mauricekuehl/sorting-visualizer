...
!(function (e) {
  ...
  function _(e, t, r) {
      ...
      n +=
        ...
        u.map
          .call(e.attributes, function (e) {
            return (
              " " + e.nodeName + '="' + C(e.value).replace(/"/g, "&quot;") + '"'
            );
          })
          .join("") +
        ">";
    ...
    for (; e.length || t.length; ) {
      var d = s();
      if (((n += C(r.substring(a, d[0].offset))), (a = d[0].offset), d === e)) {
        for (
          i.reverse().forEach(o);
          l(d.splice(0, 1)[0]),
  ...
  function B(a) {
    ...
    function n(n) {
      ...
      function t(e, t) {
        (s[r] = e),
          c.push([e, t]),
          (r += new RegExp(t.toString() + "|").exec("").length - 1 + 1);
      }
  ...
  function R(t, e, n, r) {
      ...
      (g += (
        null != f.sL
          ...
          : function () {
              var e, t, r, a, n, i, s;
              if (!f.k) return C(_);
              for (a = "", t = 0, f.lR.lastIndex = 0, r = f.lR.exec(_); r; )
    ...
    function l(e) {
      ...
      return (
        r &&
          r.endSameAsBegin &&
          (r.eR = new RegExp(t.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), "m")),
        r.skip ? (_ += t) : (r.eB && (_ += t), s(), r.rB || r.eB || (_ = t)),
        o(r),
        r.rB ? 0 : t.length
      );
    }
    function d(e) {
      ...
      if (a) {
        var n = f;
        for (
          n.skip ? (_ += t) : (n.rE || n.eE || (_ += t), s(), n.eE && (_ = t));
          f.cN && (g += k),
    ...
    try {
      ...
      for (a(i.substr(N)), p = f; p.parent; p = p.parent) p.cN && (g += k);
    ...
    var t,
      ...
      u = (function (e) {
        var t,
          ...
          i = e.className + " ";
        if (
          ((i += e.parentNode ? e.parentNode.className : ""), (r = p.exec(i)))
        ) {
          var s = A(r[1]);
          return (
            s ||
  ...
  return (
    ...
    (n.BNM = n.BINARY_NUMBER_MODE = { cN: "number", b: n.BNR, relevance: 0 }),
    ...
    (n.UTM = n.UNDERSCORE_TITLE_MODE = { cN: "title", b: n.UIR, relevance: 0 }),
      ...
      !(function t(r) {
        ...
        Object.getOwnPropertyNames(r).forEach(function (e) {
          !r.hasOwnProperty(e) ||
            ...
            (a && ("caller" === e || "callee" === e || "arguments" === e)) ||
            Object.isFrozen(r[e]) ||
            t(r[e]);
        });
        return r;
    ...
    n.registerLanguage("cpp", function (e) {
      ...
      var r = "decltype\\(auto\\)",
        a = "[a-zA-Z_]\\w*::",
        n = (t(a), t("<.*?>"), { cN: "keyword", b: "\\b[a-z\\d_]*_t\\b" }),
        i = {
          cN: "string",
          v: [
            { b: '(u8?|U|L)?"', e: '"', i: "\\n", c: [e.BE] },
        ...
        b = {
          ...
          k: d,
          c: u.concat([
            { b: /\(/, e: /\)/, k: d, c: u.concat(["self"]), relevance: 0 },
          ]),
          relevance: 0,
        },
        p = {
        ...
        c: [
          ...
          { cN: "section", b: /\[+/, e: /\]+/ },
          {
            ...
            starts: {
              ...
              c: [
                r,
                { b: /\[/, e: /\]/, c: [r, n, a, i, t, "self"], relevance: 0 },
                n,
                a,
                i,
                t,
      ...
      return {
        ...
        c: [
          ...
          { b: "@(page|font-face)", l: t, k: "@page @font-face" },
          {
            ...
            rB: !0,
            k: "and or not only",
            c: [{ b: t, cN: "keyword" }, r, e.QSM, e.ASM, a, e.CSSNM],
          },
        ],
      };
    }),
